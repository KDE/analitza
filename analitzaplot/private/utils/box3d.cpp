...
// */
// bool Box3D::intersects(const Box3D& box) const
// {
//     if (boxtype == Null)
//         return false;
...
//     \sa intersection()
// */
// bool Box3D::intersects(const Ray3D &ray) const
// {
...
//     (const Box3D &box, const Ray3D &ray, qreal t,
...
// */
// bool Box3D::intersection(const Ray3D &ray, qreal *minimum_t, qreal *maximum_t) const
// {
//     bool found = false;
...
//     \sa intersects(), QRay3D::point()
// */
// qreal Box3D::intersection(const Ray3D &ray) const
// {
//     qreal minimum_t, maximum_t;
...
// */
// Box3D Box3D::intersected(const Box3D& box) const
// {
//     Box3D result(*this);
...
//     \sa united(), intersect()
// */
// void Box3D::unite(const QVector3D& point)
// {
//     if (boxtype == Finite) {
...
//     \sa united(), intersect()
// */
// void Box3D::unite(const Box3D& box)
// {
...
// */
// Box3D Box3D::united(const QVector3D& point) const
// {
//     if (boxtype == Finite) {
//         Box3D result(*this);
//         result.unite(point);
...
//     \sa unite(), intersected()
// */
// Box3D Box3D::united(const Box3D& box) const
// {
//     if (boxtype == Finite) {
//         Box3D result(*this);
//         result.unite(box);
...
//     \sa transformed()
// */
// void Box3D::transform(const QMatrix4x4& matrix)
// {
...
//     \sa transform()
// */
// Box3D Box3D::transformed(const QMatrix4x4& matrix) const
// {
//     if (boxtype != Finite)
//         return *this;
//     Box3D result;

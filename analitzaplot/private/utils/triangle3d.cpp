...
/*!
    ...
    \sa intersects()
*/
bool Triangle3D::contains(const QVector3D &point) const
{
 ...
 */
qreal Triangle3D::intersection(const Ray3D &ray) const
{
    qreal t = plane().intersection(ray);
...
/*!
    ...
    \sa transformed()
*/
void Triangle3D::transform(const QMatrix4x4 &matrix)
{
    m_p = matrix * m_p;
    m_q = matrix * m_q;
    m_r = matrix * m_r;
...
/*!
    ...
    \sa transform()
*/
Triangle3D Triangle3D::transformed(const QMatrix4x4 &matrix) const
{
    return Triangle3D(matrix * m_p, matrix * m_q, matrix * m_r);
}
...
/*!
    ...
    \sa contains(), intersection()
*/
QVector2D Triangle3D::uv(const QVector3D &point) const
{

...
// ///
// 
// PlaneCurvesModel::PlaneCurvesModel(QObject* parent): VisualItemsModel(parent)
// {
// 
// }
// 
...
// {
//     static_cast<PlaneCurve*>(m_items[curveIndex])->update(viewport);
// 
...
// 
//     return static_cast<PlaneCurve*>(m_items[row])->image(mousepos);
// }
// 
...
//     Q_ASSERT(row<m_items.count());
// 
//     return static_cast<PlaneCurve*>(m_items[row])->tangent(mousepos);
// }
// 
